...
from .base_eviction_policy import (BaseEvictionPolicy, BaseEvictionPolicyNode,
                                   Functor, V)
...
class FIFONode(BaseEvictionPolicyNode[V]):
    ...
    def __init__(self, key: Hashable, value: V):
        ...
        self.next: FIFONode = None
        self.prev: FIFONode = None
...
class FIFO(BaseEvictionPolicy[FIFONode, V]):
    ...
    def __init__(
        ...
        self._head: FIFONode = None
        self._tail: FIFONode = None
