...
# cd $USER_HOME/v6d #&& git submodule update --init --recursive
...
pip3 install $USER_HOME/vineyard-linux-x86_64-wheels/vineyard_bdist-0.23.2-py3-none-manylinux2014_x86_64.whl
pip3 install $USER_HOME/vineyard-linux-x86_64-wheels/vineyard-0.23.2-cp310-cp310-manylinux_2_17_x86_64.manylinux2014_x86_64.whl
pip3 install $USER_HOME/vineyard-linux-x86_64-wheels/vineyard_llm-0.23.2-cp310-cp310-manylinux_2_17_x86_64.manylinux2014_x86_64.whl
# find / -name vineyardd 2>/dev/null
# /home/ubuntu/.local/lib/python3.10/site-packages/vineyard/bdist/vineyardd
#########################################################
ETCD_VER=v3.4.33
...
# /home/ubuntu/.local/lib/python3.10/site-packages/vineyard/bdist/vineyardd --socket /tmp/vineyard_test.sock 1>out.log 2>&1 &
# $USER_HOME/v6d/build/bin/vineyardd --socket /tmp/vineyard_test.sock 1>out.log 2>&1 &
# $USER_HOME/v6d/build/bin/vineyardd --socket /tmp/vineyard_test.sock --etcd_cmd /tmp/etcd-download-test/etcdctl 1>out.log 2>&1 &

#build and install vllm 
cd $USER_HOME/vllm
# git checkout lexu/vineyard-adptation 
pip3 install -e .
...
# source ~/lexu/v2_config.sh 

# python benchmark_prefix_caching.py         --model facebook/opt-125m         --dataset-path /tmp/ShareGPT_V3_unfiltered_cleaned_split.json         --num-prompts 20         --repeat-count 5         --input-length-range 128:256

# python benchmark_prefix_caching.py         --model facebook/opt-125m         --dataset-path /tmp/ShareGPT_V3_unfiltered_cleaned_split.json         --num-prompts 20         --repeat-count 5         --input-length-range 128:256 1>out.log 2>&1 &